;
(function () {
    if (typeof wp == 'undefined' || typeof wp.blocks == 'undefined' || typeof wp.i18n == 'undefined' || typeof wp.i18n.__ == 'undefined' || typeof wp.blocks.registerBlockType == 'undefined') return false;
    const {
        __
    } = wp.i18n;
    const {
    ...
    registerBlockType('ajax-search-lite/block-asl-main', {
        ...
        edit: function (props) {
            return /*#__PURE__*/React.createElement(ServerSideRender, {
                block: "ajax-search-lite/block-asl-main"
            });
        },
        save: function (props) {
            return /*#__PURE__*/React.createElement(AslShortcode, null);
        }
    });
})();