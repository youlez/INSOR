<?php  function wpbc_all_translations1() { $wpbc_all_translations = array(); 
 ...
 $wpbc_all_translations[] = __('Unavailable time from current time', 'booking'); 
 $wpbc_all_translations[] = __('Select an unavailable time interval on the calendar, starting from today\'s current time.', 'booking'); 
 ...
 $wpbc_all_translations[] = __('Support Forum', 'booking'); 
 $wpbc_all_translations[] = __('Contact Support', 'booking'); 
 $wpbc_all_translations[] = __('About', 'booking'); 
