...
<div class="tribe-events-calendar-month__calendar-event-tooltip-featured-image-wrapper">
	<a
		<?php echo esc_url(get_post_meta($event->ID, '_EventURL', true) != "" ? 'target="_blank"' : ''); ?>
		href="<?php echo esc_url(get_post_meta($event->ID, '_EventURL', true) != "" ? get_post_meta($event->ID, '_EventURL', true) : $event->permalink); ?>"
