...
<?php
    ...
    wp_register_script('general', get_template_directory_uri() . '/js/front/general.js', array(), '2024.10.30.02', 'all');
    wp_register_script('videos', get_template_directory_uri() . '/js/front/videos.js', array(), '2024.10.30.02', 'all');
    wp_register_script('menu', get_template_directory_uri() . '/js/front/menu.js', array(), '2024.10.30.02', 'all');
    wp_register_script('home', get_template_directory_uri() . '/js/front/home.js', array(), '2024.10.30.02', 'all');
    wp_register_script('header', get_template_directory_uri() . '/js/front/header.js', array(), '2024.10.30.02', 'all');
    wp_register_script('accesibilidad', get_template_directory_uri() . '/js/front/accesibilidad.js', array(), '2024.10.30.02', 'all');
    wp_register_script('lista-desplegable', get_template_directory_uri() . '/js/front/lista-desplegable.js', array(), '2024.10.30.02', 'all');
    wp_register_script('page', get_template_directory_uri() . '/js/front/page.js', array(), '2024.10.30.02', 'all');
    wp_register_script('glosario', get_template_directory_uri() . '/js/front/glosario.js', array(), '2024.10.30.02', 'all');
...
function cargar_estilos_head()
{
    ...
    wp_register_style('style', get_template_directory_uri() . '/style.css', array(), '2024.10.30.02', 'all');
...
{
    wp_register_style('buscador', get_template_directory_uri() . '/css/buscador.css', array(), '2024.10.30.02', 'all');
