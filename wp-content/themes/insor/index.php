    ...
    <div class="col-lg-6" id="mask">
      <a href="#">
        ...
        <div class="tooltip" id="tooltip">
          <img src="<?php bloginfo('template_url'); ?>/assets/img/banner/INSOR_EDUCATIVO.gif">
        </div>
      </a>
...
<section class="mb-4">
  <div class="row titleContainer mt-4">
    <div class="col-lg-2 title ">
      <h3>
        DESTACADOS
      </h3>
...
<section class="mb-4">
  ...
  <div class="row insor_niños">
    <a target="_blank">
      <img href="https://www.insor.gov.co/portalninos/" src="<?php bloginfo('template_url'); ?> /assets/img/niños/insor_niños.jpg" class="d-block w-100">
    </a>
